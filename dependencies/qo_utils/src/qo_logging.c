...
#ifdef _WIN32
#undef OUTPUT_TO_SYSLOG_ENABLED
...
#if defined(OUTPUT_TO_CONSOLE_ENABLED) && !defined(_WIN32)
...
bool qo_getToken(const char *pSrcData, char *pDstField, int nFieldNum, int nDstFieldMaxLen)
///////////////////////////////////////////////////////////////////////////////
// Name:    GetToken
...
///////////////////////////////////////////////////////////////////////////////
{
    ...
    qo_trimLeading(pDstField, (char *)" [");
    qo_trimTrailing(pDstField, (char *)" ]");

    app_trace_hex("TRACE: GetToken pSrcData=", (unsigned char *)pSrcData, strlen(pSrcData));
    char buf[20];
    qo_itoa(nFieldNum, buf, 10);
...
void qo_dumpToFile(const char *szFilename, const unsigned char *p, size_t n)
{
