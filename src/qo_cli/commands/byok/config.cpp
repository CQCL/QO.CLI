...
namespace Quantinuum::QuantumOrigin::Cli::Commands::Byok
{
    ...
    ByokConfig::ByokConfig(const std::string &configPath) : ByokConfig(cfgFromFile(configPath)) {}

    ByokConfig::ByokConfig(const YAML::Node &cfg)
    ...
    ByokConfig::ByokConfig(KeyParametersConfig keyParametersConfig, CredentialsConfig credentialsConfig)
