...
namespace Quantinuum::QuantumOrigin::Cli::Commands::RandomnessApi
{
    ...
    class RandomnessApiConfig
    {
      public:
        explicit RandomnessApiConfig(const std::string &configPath);
        explicit RandomnessApiConfig(const YAML::Node &cfg);
        RandomnessApiConfig(KeyParametersConfig keyParametersConfig, CredentialsConfig credentialsConfig, GeneralConfig generalConfig);
