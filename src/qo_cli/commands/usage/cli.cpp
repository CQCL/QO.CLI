...
namespace Quantinuum::QuantumOrigin::Cli::Commands::Usage
{
    ...
    UsageCliCommand::UsageCliCommand() : CliCommand("usage", "get usage info from QO", {"us"}) {}
    ...
    void UsageCliCommand::addParameters(CLI::App &parent, UsageParameters &parameters)
    {
        ...
        optUsageTo->group("Usage");
        optUsageGroupBy->group("Usage");

        optUsageGroupBy->transform(CLI::CheckedTransformer(usageQueryMap, CLI::ignore_case));
    }
